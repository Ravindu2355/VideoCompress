...
class Config(object):
    ...
    # Put MongoDB URL
    DATABASE_URL = get_config("dburl", "")
    # get a token from @BotFather
    TG_BOT_TOKEN = get_config("tk", "")
    # The Telegram API things
    APP_ID = int(get_config("apiid", 12345))
    API_HASH = get_config("apihash", "")
    LOG_CHANNEL = get_config("logc")
    UPDATES_CHANNEL = get_config("upc") # Without `@` LOL
